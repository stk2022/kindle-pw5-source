...
#define CONFIG_AMAZON_METRICS_LOG

#if defined(CONFIG_AMAZON_METRICS_LOG)
#define ANDROID_LOG_INFO	KERN_INFO
#define log_to_metrics(priority, domain, log_msg) \
			printk(priority "%s:%s\n", domain, log_msg)
#endif
...
#define wpc_printk(fmt, args...) pr_debug("[WPC_INFO]" fmt, ##args)
