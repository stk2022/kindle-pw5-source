...
#define MXCFB_SET_WAVEFORM_MODES _IOW(HWTCON_IOCTL_MAGIC_NUMBER, 0x2B, \
	struct mxcfb_waveform_modes)
...
#define MXCFB_SEND_UPDATE		_IOW(HWTCON_IOCTL_MAGIC_NUMBER, 0x2E, \
	struct mxcfb_update_data)
 ...
 */
#define MXCFB_WAIT_FOR_UPDATE_SUBMISSION _IOW(HWTCON_IOCTL_MAGIC_NUMBER, 0x37, \
	__u32)
 ...
 */
#define MXCFB_WAIT_FOR_UPDATE_COMPLETE	_IOWR(HWTCON_IOCTL_MAGIC_NUMBER, \
	0x2F, struct mxcfb_update_marker_data)

/* Copy the content of the working buffer to user space */
#define MXCFB_GET_WORK_BUFFER _IOWR(HWTCON_IOCTL_MAGIC_NUMBER, 0x34, \
	unsigned long)
 ...
 */
#define MXCFB_SET_NIGHTMODE  _IOR(HWTCON_IOCTL_MAGIC_NUMBER, 0x4A, \
	struct mxcfb_nightmode_ctrl)
...
#define MXCFB_GET_PANEL_INFO _IOR(HWTCON_IOCTL_MAGIC_NUMBER, \
	0x130, struct mxcfb_panel_info)
