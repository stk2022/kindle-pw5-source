...
#ifndef LINUX_POWER_MTK_CHARGER_CLASS_H
#define LINUX_POWER_MTK_CHARGER_CLASS_H
...
extern int wireless_charger_dev_get_temp(struct charger_device *chg_dev);
...
extern int wireless_charger_dev_set_sleep_en(struct charger_device *chg_dev, bool en);
extern int wireless_charger_dev_set_wpc_en(struct charger_device *chg_dev, bool en);

#endif /*LINUX_POWER_MTK_CHARGER_CLASS_H*/
