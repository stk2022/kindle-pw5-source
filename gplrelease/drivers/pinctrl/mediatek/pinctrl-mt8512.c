...
static const struct mtk_pin_field_calc mt8512_pin_pupd_range[] = {
	PIN_FIELD(0, 0, 0x0F0, 0x10, 14, 1),
	PIN_FIELD(1, 1, 0x0F0, 0x10, 17, 1),
	PIN_FIELD(2, 2, 0x0F0, 0x10, 20, 1),
	PIN_FIELD(3, 3, 0x0F0, 0x10, 23, 1),
	PIN_FIELD(4, 4, 0x0F0, 0x10, 26, 1),
	PIN_FIELD(5, 5, 0x0F0, 0x10, 29, 1),
	PIN_FIELD(6, 6, 0x300, 0x10, 2, 1),
	PIN_FIELD(7, 7, 0x300, 0x10, 5, 1),
	PIN_FIELD(8, 8, 0x300, 0x10, 8, 1),
	PIN_FIELD(9, 9, 0x300, 0x10, 11, 1),
	PIN_FIELD(10, 10, 0x300, 0x10, 14, 1),
	PIN_FIELD(11, 11, 0x300, 0x10, 17, 1),
	PIN_FIELD(32, 32, 0x300, 0x10, 20, 1),
	PIN_FIELD(40, 40, 0x070, 0x10, 2, 1),
	PIN_FIELD(41, 41, 0x070, 0x10, 5, 1),
	PIN_FIELD(42, 42, 0x070, 0x10, 8, 1),
	PIN_FIELD(43, 43, 0x070, 0x10, 11, 1),
	PIN_FIELD(44, 44, 0x300, 0x10, 23, 1),
	PIN_FIELD(45, 45, 0x300, 0x10, 26, 1),
	PIN_FIELD(46, 46, 0x300, 0x10, 29, 1),
	PIN_FIELD(47, 47, 0x310, 0x10, 2, 1),
	PIN_FIELD(70, 70, 0x080, 0x10, 5, 1),
	PIN_FIELD(71, 71, 0x080, 0x10, 8, 1),
	PIN_FIELD(72, 72, 0x080, 0x10, 11, 1),
	PIN_FIELD(73, 73, 0x080, 0x10, 14, 1),
	PIN_FIELD(74, 74, 0x080, 0x10, 17, 1),
	PIN_FIELD(75, 75, 0x080, 0x10, 20, 1),
	PIN_FIELD(76, 76, 0x080, 0x10, 23, 1),
	PIN_FIELD(77, 77, 0x080, 0x10, 26, 1),
	PIN_FIELD(78, 78, 0x080, 0x10, 29, 1),
	PIN_FIELD(79, 79, 0x090, 0x10, 2, 1),
	PIN_FIELD(80, 80, 0x090, 0x10, 5, 1),
	PIN_FIELD(81, 81, 0x090, 0x10, 8, 1),
	PIN_FIELD(82, 82, 0x090, 0x10, 11, 1),
	PIN_FIELD(83, 83, 0x090, 0x10, 14, 1),
	PIN_FIELD(84, 84, 0x090, 0x10, 17, 1),
	PIN_FIELD(85, 85, 0x090, 0x10, 20, 1),
	PIN_FIELD(86, 86, 0x090, 0x10, 23, 1),
	PIN_FIELD(87, 87, 0x310, 0x10, 5, 1),
	PIN_FIELD(92, 92, 0x310, 0x10, 20, 1),
	PIN_FIELD(93, 93, 0x310, 0x10, 23, 1),
	PIN_FIELD(94, 94, 0x310, 0x10, 26, 1),
	PIN_FIELD(95, 95, 0x310, 0x10, 29, 1),
	PIN_FIELD(96, 96, 0x320, 0x10, 2, 1),
	PIN_FIELD(97, 97, 0x320, 0x10, 5, 1),
	PIN_FIELD(98, 98, 0x320, 0x10, 8, 1),
	PIN_FIELD(99, 99, 0x320, 0x10, 11, 1),
	PIN_FIELD(100, 100, 0x320, 0x10, 14, 1),
	PIN_FIELD(101, 101, 0x320, 0x10, 17, 1),
	PIN_FIELD(102, 102, 0x320, 0x10, 20, 1),
	PIN_FIELD(103, 103, 0x320, 0x10, 23, 1),
	PIN_FIELD(104, 104, 0x320, 0x10, 26, 1),
	PIN_FIELD(105, 105, 0x320, 0x10, 29, 1),
	PIN_FIELD(106, 106, 0x330, 0x10, 2, 1),
	PIN_FIELD(107, 107, 0x330, 0x10, 5, 1),
	PIN_FIELD(108, 108, 0x330, 0x10, 8, 1),
	PIN_FIELD(109, 109, 0x330, 0x10, 11, 1),
	PIN_FIELD(110, 110, 0x330, 0x10, 14, 1),
	PIN_FIELD(111, 111, 0x330, 0x10, 17, 1),
};

static const struct mtk_pin_field_calc mt8512_pin_r0_range[] = {
	PIN_FIELD(0, 0, 0x0F0, 0x10, 12, 1),
	PIN_FIELD(1, 1, 0x0F0, 0x10, 15, 1),
	PIN_FIELD(2, 2, 0x0F0, 0x10, 18, 1),
	PIN_FIELD(3, 3, 0x0F0, 0x10, 21, 1),
	PIN_FIELD(4, 4, 0x0F0, 0x10, 24, 1),
	PIN_FIELD(5, 5, 0x0F0, 0x10, 27, 1),
	PIN_FIELD(6, 6, 0x300, 0x10, 0, 1),
	PIN_FIELD(7, 7, 0x300, 0x10, 3, 1),
	PIN_FIELD(8, 8, 0x300, 0x10, 6, 1),
	PIN_FIELD(9, 9, 0x300, 0x10, 9, 1),
	PIN_FIELD(10, 10, 0x300, 0x10, 12, 1),
	PIN_FIELD(11, 11, 0x300, 0x10, 15, 1),
	PIN_FIELD(32, 32, 0x300, 0x10, 18, 1),
	PIN_FIELD(40, 40, 0x070, 0x10, 0, 1),
	PIN_FIELD(41, 41, 0x070, 0x10, 3, 1),
	PIN_FIELD(42, 42, 0x070, 0x10, 6, 1),
	PIN_FIELD(43, 43, 0x070, 0x10, 9, 1),
	PIN_FIELD(44, 44, 0x300, 0x10, 21, 1),
	PIN_FIELD(45, 45, 0x300, 0x10, 24, 1),
	PIN_FIELD(46, 46, 0x300, 0x10, 27, 1),
	PIN_FIELD(47, 47, 0x310, 0x10, 0, 1),
	PIN_FIELD(70, 70, 0x080, 0x10, 3, 1),
	PIN_FIELD(71, 71, 0x080, 0x10, 6, 1),
	PIN_FIELD(72, 72, 0x080, 0x10, 9, 1),
	PIN_FIELD(73, 73, 0x080, 0x10, 12, 1),
	PIN_FIELD(74, 74, 0x080, 0x10, 15, 1),
	PIN_FIELD(75, 75, 0x080, 0x10, 18, 1),
	PIN_FIELD(76, 76, 0x080, 0x10, 21, 1),
	PIN_FIELD(77, 77, 0x080, 0x10, 24, 1),
	PIN_FIELD(78, 78, 0x080, 0x10, 27, 1),
	PIN_FIELD(79, 79, 0x090, 0x10, 0, 1),
	PIN_FIELD(80, 80, 0x090, 0x10, 3, 1),
	PIN_FIELD(81, 81, 0x090, 0x10, 6, 1),
	PIN_FIELD(82, 82, 0x090, 0x10, 9, 1),
	PIN_FIELD(83, 83, 0x090, 0x10, 12, 1),
	PIN_FIELD(84, 84, 0x090, 0x10, 15, 1),
	PIN_FIELD(85, 85, 0x090, 0x10, 18, 1),
	PIN_FIELD(86, 86, 0x090, 0x10, 21, 1),
	PIN_FIELD(87, 87, 0x310, 0x10, 3, 1),
	PIN_FIELD(92, 92, 0x310, 0x10, 18, 1),
	PIN_FIELD(93, 93, 0x310, 0x10, 21, 1),
	PIN_FIELD(94, 94, 0x310, 0x10, 24, 1),
	PIN_FIELD(95, 95, 0x310, 0x10, 27, 1),
	PIN_FIELD(96, 96, 0x320, 0x10, 0, 1),
	PIN_FIELD(97, 97, 0x320, 0x10, 3, 1),
	PIN_FIELD(98, 98, 0x320, 0x10, 6, 1),
	PIN_FIELD(99, 99, 0x320, 0x10, 9, 1),
	PIN_FIELD(100, 100, 0x320, 0x10, 12, 1),
	PIN_FIELD(101, 101, 0x320, 0x10, 15, 1),
	PIN_FIELD(102, 102, 0x320, 0x10, 18, 1),
	PIN_FIELD(103, 103, 0x320, 0x10, 21, 1),
	PIN_FIELD(104, 104, 0x320, 0x10, 24, 1),
	PIN_FIELD(105, 105, 0x320, 0x10, 27, 1),
	PIN_FIELD(106, 106, 0x330, 0x10, 0, 1),
	PIN_FIELD(107, 107, 0x330, 0x10, 3, 1),
	PIN_FIELD(108, 108, 0x330, 0x10, 6, 1),
	PIN_FIELD(109, 109, 0x330, 0x10, 9, 1),
	PIN_FIELD(110, 110, 0x330, 0x10, 12, 1),
	PIN_FIELD(111, 111, 0x330, 0x10, 15, 1),
};

static const struct mtk_pin_field_calc mt8512_pin_r1_range[] = {
	PIN_FIELD(0, 0, 0x0F0, 0x10, 13, 1),
	PIN_FIELD(1, 1, 0x0F0, 0x10, 16, 1),
	PIN_FIELD(2, 2, 0x0F0, 0x10, 19, 1),
	PIN_FIELD(3, 3, 0x0F0, 0x10, 22, 1),
	PIN_FIELD(4, 4, 0x0F0, 0x10, 25, 1),
	PIN_FIELD(5, 5, 0x0F0, 0x10, 28, 1),
	PIN_FIELD(6, 6, 0x300, 0x10, 1, 1),
	PIN_FIELD(7, 7, 0x300, 0x10, 4, 1),
	PIN_FIELD(8, 8, 0x300, 0x10, 7, 1),
	PIN_FIELD(9, 9, 0x300, 0x10, 10, 1),
	PIN_FIELD(10, 10, 0x300, 0x10, 13, 1),
	PIN_FIELD(11, 11, 0x300, 0x10, 16, 1),
	PIN_FIELD(32, 32, 0x300, 0x10, 19, 1),
	PIN_FIELD(40, 40, 0x070, 0x10, 1, 1),
	PIN_FIELD(41, 41, 0x070, 0x10, 4, 1),
	PIN_FIELD(42, 42, 0x070, 0x10, 7, 1),
	PIN_FIELD(43, 43, 0x070, 0x10, 10, 1),
	PIN_FIELD(44, 44, 0x300, 0x10, 22, 1),
	PIN_FIELD(45, 45, 0x300, 0x10, 25, 1),
	PIN_FIELD(46, 46, 0x300, 0x10, 28, 1),
	PIN_FIELD(47, 47, 0x310, 0x10, 1, 1),
	PIN_FIELD(70, 70, 0x080, 0x10, 4, 1),
	PIN_FIELD(71, 71, 0x080, 0x10, 7, 1),
	PIN_FIELD(72, 72, 0x080, 0x10, 10, 1),
	PIN_FIELD(73, 73, 0x080, 0x10, 13, 1),
	PIN_FIELD(74, 74, 0x080, 0x10, 16, 1),
	PIN_FIELD(75, 75, 0x080, 0x10, 19, 1),
	PIN_FIELD(76, 76, 0x080, 0x10, 22, 1),
	PIN_FIELD(77, 77, 0x080, 0x10, 25, 1),
	PIN_FIELD(78, 78, 0x080, 0x10, 28, 1),
	PIN_FIELD(79, 79, 0x090, 0x10, 1, 1),
	PIN_FIELD(80, 80, 0x090, 0x10, 4, 1),
	PIN_FIELD(81, 81, 0x090, 0x10, 7, 1),
	PIN_FIELD(82, 82, 0x090, 0x10, 10, 1),
	PIN_FIELD(83, 83, 0x090, 0x10, 13, 1),
	PIN_FIELD(84, 84, 0x090, 0x10, 16, 1),
	PIN_FIELD(85, 85, 0x090, 0x10, 19, 1),
	PIN_FIELD(86, 86, 0x090, 0x10, 22, 1),
	PIN_FIELD(87, 87, 0x310, 0x10, 4, 1),
	PIN_FIELD(92, 92, 0x310, 0x10, 19, 1),
	PIN_FIELD(93, 93, 0x310, 0x10, 22, 1),
	PIN_FIELD(94, 94, 0x310, 0x10, 25, 1),
	PIN_FIELD(95, 95, 0x310, 0x10, 28, 1),
	PIN_FIELD(96, 96, 0x320, 0x10, 1, 1),
	PIN_FIELD(97, 97, 0x320, 0x10, 4, 1),
	PIN_FIELD(98, 98, 0x320, 0x10, 7, 1),
	PIN_FIELD(99, 99, 0x320, 0x10, 10, 1),
	PIN_FIELD(100, 100, 0x320, 0x10, 13, 1),
	PIN_FIELD(101, 101, 0x320, 0x10, 16, 1),
	PIN_FIELD(102, 102, 0x320, 0x10, 19, 1),
	PIN_FIELD(103, 103, 0x320, 0x10, 22, 1),
	PIN_FIELD(104, 104, 0x320, 0x10, 25, 1),
	PIN_FIELD(105, 105, 0x320, 0x10, 28, 1),
	PIN_FIELD(106, 106, 0x330, 0x10, 1, 1),
	PIN_FIELD(107, 107, 0x330, 0x10, 4, 1),
	PIN_FIELD(108, 108, 0x330, 0x10, 7, 1),
	PIN_FIELD(109, 109, 0x330, 0x10, 10, 1),
	PIN_FIELD(110, 110, 0x330, 0x10, 13, 1),
	PIN_FIELD(111, 111, 0x330, 0x10, 16, 1),
};
...
static const struct mtk_pin_reg_calc mt8512_reg_cals[] = {
	...
	[PINCTRL_PIN_REG_PUPD] = MTK_RANGE(mt8512_pin_pupd_range),
	[PINCTRL_PIN_REG_R0] = MTK_RANGE(mt8512_pin_r0_range),
	[PINCTRL_PIN_REG_R1] = MTK_RANGE(mt8512_pin_r1_range),
...
/* unused pin */
static int mt8512_unused0_pins[] = { 10, };
static int mt8512_unused0_funcs[] = { 0, };


static const char *const mt8512_unused0_groups[] = { "unused0" };
...
static const struct mtk_group_desc mt8512_groups[] = {
	...
	PINCTRL_PIN_GROUP("unused0", mt8512_unused0),
};
...
static const struct mtk_function_desc mt8512_functions[] = {
	...
	{"unused0", mt8512_unused0_groups, ARRAY_SIZE(mt8512_unused0_groups)},
};
