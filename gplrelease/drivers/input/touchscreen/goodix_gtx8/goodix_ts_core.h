...
/* macros definition */
#define GOODIX_CORE_DRIVER_NAME		"goodix-ts"
#define GOODIX_PEN_DRIVER_NAME		"goodix-ts,pen"
#define GOODIX_DRIVER_VERSION		"v1.4.4.2"
...
#define GOODIX_TOUCH_PROC_FILE         "touch"
/*
...
struct goodix_ts_core {
	...
	enum goodix_ts_fb_state fb_state;
