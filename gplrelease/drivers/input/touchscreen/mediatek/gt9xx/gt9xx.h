...
#define GTP_POWER_CTRL_SLEEP 1 // power off when suspend
#define GTP_ICS_SLOT_REPORT 1  // slot protocol

#define GTP_AUTO_UPDATE 0 // auto update fw by .bin file as default
#define GTP_HEADER_FW_UPDATE                                                   \
	0 // auto update fw by gtp_default_FW in gt9xx_firmware.h, function
	  // together with GTP_AUTO_UPDATE
#define GTP_AUTO_UPDATE_CFG                                                    \
	0 // auto update config by .cfg file, function together with
	  // GTP_AUTO_UPDATE
#define GTP_AUTO_UPDATE_FORCE                                                  \
	0 // force auto update fw by .bin file as default, function together
	  // with GTP_AUTO_UPDATE
#define GTP_AUTO_UPDATE_CFG_FORCE                                              \
	0 // force auto update config by .cfg file, function together with
	  // GTP_AUTO_UPDATE_CFG
...
#define TOUCH_MISC_DEV_NAME "goodix"
#define TOUCH_IOCTL_GET_LOCK 0
#define TOUCH_IOCTL_SET_LOCK 1
...
// The predefined one is just a sample config, which is not suitable for your tp
// in most cases.
#define CTP_CFG_GROUP0                                                          \
	{                                                                       \
		/* CFG is defined in device tree */                             \
		/*                                                              \
...
#if GTP_CUSTOM_CFG
#define GTP_MAX_HEIGHT 1448
#define GTP_MAX_WIDTH 1072
#define GTP_INT_TRIGGER 1 // 0: Rising 1: Falling
#define GTP_MAX_TOUCH 2
#else
...
// STEP_4(optional): If keys are available and reported as keys, config your key
// info here
#if GTP_HAVE_TOUCH_KEY
#define GTP_KEY_TAB                                                            \
	{                                                                      \
		KEY_MENU, KEY_HOME, KEY_BACK, KEY_HOMEPAGE, KEY_F1, KEY_F2,    \
			KEY_F3                                                 \
	}
#endif
...
#define GTP_TOUCH_PROC_FILE "touch"
#define GTP_POLL_TIME 10
#define GTP_ADDR_LENGTH 2
#define GTP_CONFIG_MIN_LENGTH 186
#define GTP_CONFIG_MAX_LENGTH 228
#define FAIL 0
#define SUCCESS 1
#define SWITCH_OFF 0
#define SWITCH_ON 1
...
#define GTP_DEBUG_FUNC()                                                       \
	do {                                                                   \
		if (GTP_DEBUG_FUNC_ON)                                         \
			pr_info("<<-GTP-FUNC->> Func:%s@Line:%d\n", __func__,  \
				__LINE__);                                     \
	} while (0)
#define GTP_SWAP(x, y)                                                         \
	do {                                                                   \
