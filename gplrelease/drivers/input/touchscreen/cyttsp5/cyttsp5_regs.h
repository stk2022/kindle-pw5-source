...
/***** Force lift off on wake *****/
#define FORCE_LIFT_OFF_ON_WAKE	1

/* #define EASYWAKE_TSG6 */

#define CY_FW_FILE_DIR	"cyttsp5/"
...
#else
#define CY_HID_OUTPUT_TIMEOUT			600
#endif
...
enum cyttsp5_op_param {
	CY_OPT_PARAM_CHGR_STA		= 0x09, //Charger Status
	CY_OP_PARAM_ACT_DIS		= 0x0A, // touch point distance before reporting new
	CY_OP_PARAM_ACT_DIS2		= 0x0B, // touch point distance 2 before reporting new
	CY_OPT_PARAM_SIZE_ORI_EN	= 0x0C, //Size and Orientation Enable
	CY_OPT_PARAM_GRP_XA		= 0x0E, //GripX_A,                                2 bytes
	CY_OPT_PARAM_GRP_XB		= 0x0F, //GripX_B,                                2 bytes
	CY_OPT_PARAM_GRP_XEXA		= 0x10, //GripXexc_A,                          2 bytes
	CY_OPT_PARAM_GRP_XEXB		= 0x11, //GripXexc_B,                          2 bytes
	CY_OPT_PARAM_GRP_YA		= 0x12, //GripY_A,                                2 bytes
	CY_OPT_PARAM_GRP_YB		= 0x13, //GripY_B,                                2 bytes
	CY_OPT_PARAM_GRP_YEXA		= 0x14, //GripYexc_A,                          2 bytes
	CY_OPT_PARAM_GRP_YEXB		= 0x15, //GripYexc_B,                          2 bytes
	CY_OPT_PARAM_GRP_1ST_EXC	= 0x16, //FirstExc
	CY_OPT_PARAM_GRP_EXC_EDG_ORG	= 0x17, //ExcEdgeOrigin
	CY_OPT_PARAM_GRP_SUP_EN	= 0x18, //grip suppression global enable
};
...
#endif
	u8 watchdog_enabled;	//WDT state variable
	bool exlock;
	u8 grip_sup_en;
};
struct gd_sensor {
