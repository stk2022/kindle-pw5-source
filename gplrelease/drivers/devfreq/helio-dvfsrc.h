...
#define SPM_SW_RSV_6                   (0x64C)
#define SPM_SW_RSV_7                   (0x650)
#define SPM_SW_RSV_8                   (0x654)
#define SPM_SW_RSV_10                  (0x65C)
#define SPM_SW_RSV_11                  (0x660)
#define SPM_SW_RSV_12                  (0x664)
#define SPM_SW_RSV_13                  (0x668)
#define SPM_SW_RSV_14                  (0x66C)
#define SPM_SW_RSV_15                  (0x670)
#define SPM_SW_RSV_16                  (0x674)
#define SPM_SW_RSV_17                  (0x678)
#define SPM_SW_RSV_18                  (0x67C)

#define SPM_DFS_LEVEL                  (0x6B0)
#define SPM_DVS_LEVEL                  (0x6B4)
#define SPM_DVFS_CMD0                  (0x710)
#define SPM_DVFS_CMD1                  (0x714)
#define SPM_DVFS_CMD2                  (0x718)
#define SPM_DVFS_CMD3                  (0x71C)
#define SPM_DVFS_CMD4                  (0x720)
#define SPM_DVFS_CMD5                  (0x724)
#define SPM_DVFS_CMD6                  (0x728)
#define SPM_DVFS_CMD7                  (0x72C)
/* PMIC */
...
extern u32 spm_read(u32 offset);
