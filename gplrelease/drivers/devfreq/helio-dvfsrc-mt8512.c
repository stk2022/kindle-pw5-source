...
void get_spm_reg(char *p)
{
	...
	p += sprintf(p, "%-24s: 0x%08x, 0x%08x, 0x%08x\n",
			...
			spm_read(SPM_SW_RSV_12));
	p += sprintf(p, "%-24s: 0x%08x, 0x%08x, 0x%08x, 0x%08x, 0x%08x\n",
			"SPM_SW_RSV_13~17",
			spm_read(SPM_SW_RSV_13),
			spm_read(SPM_SW_RSV_14),
			spm_read(SPM_SW_RSV_15),
			spm_read(SPM_SW_RSV_16),
			spm_read(SPM_SW_RSV_17));
	p += sprintf(p, "%-24s: 0x%08x\n",
			"SPM_DFS_LEVEL",
