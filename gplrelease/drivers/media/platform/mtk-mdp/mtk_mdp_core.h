 ...
 * @ctrl_get_brightness_level: get the level of brightness from the config file
 * @ctrl_get_contrast_level:get the level of contrast from the config file
 * @ctrl_store_brightness_level:store the brightness level into the config file
 * @ctrl_store_contrast_level:store the contrast level into the config file
...
struct mtk_mdp_ctrls {
	...
	struct v4l2_ctrl *ctrl_get_brightness_level;
	struct v4l2_ctrl *ctrl_get_contrast_level;
	struct v4l2_ctrl *ctrl_store_brightness_level;
	struct v4l2_ctrl *ctrl_store_contrast_level;
	struct v4l2_ctrl *eng_flag;

	struct v4l2_ext_controls *ctrl_gamma_enable;
	struct v4l2_ext_controls *ctrl_gamma_type;
	struct v4l2_ext_controls *ctrl_gamma_table;
	struct v4l2_ext_controls *ctrl_invert;
	struct v4l2_ext_controls *ctrl_dth_enable;
	struct v4l2_ext_controls *ctrl_dth_algo;
	struct v4l2_ext_controls *ctrl_rsz_algo;
};
