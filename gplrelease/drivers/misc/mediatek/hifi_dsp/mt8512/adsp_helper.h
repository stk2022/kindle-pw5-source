...
#define TOTAL_SIZE_SHARED_DRAM_FROM_TAIL  (0x30000)  /* 192KB */

#define DTCM_PHYS_BASE_FROM_DSP_VIEW  (0x40020000) /* MT8512 DSP view */
#define DRAM_PHYS_BASE_FROM_DSP_VIEW  (0x40060000) /* MT8512 DSP view */
/*
...
#define INFRA_AO_SEC_CON              (0x10000F80) /*bit22*/
