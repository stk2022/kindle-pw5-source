...
#define REAGL_BASE_VA	hwtcon_driver_get_regal_va()
#define REAGL_BASE		hwtcon_driver_get_regal_pa()
...
static void hwtcon_regal_config_regal_d(struct cmdqRecStruct *pkt)
{
	regal_write(pkt, REAGL_MASK_000, 0x43276510);
	regal_write(pkt, REAGL_MASK_001, 0x43276510);
	regal_write(pkt, REAGL_MASK_002, 0x76510432);
	regal_write(pkt, REAGL_MASK_003, 0x76510432);
	regal_write(pkt, REAGL_MASK_004, 0x10432765);
	regal_write(pkt, REAGL_MASK_005, 0x10432765);
	regal_write(pkt, REAGL_MASK_006, 0x32765104);
	regal_write(pkt, REAGL_MASK_007, 0x32765104);
	regal_write(pkt, REAGL_MASK_008, 0x65104327);
	regal_write(pkt, REAGL_MASK_009, 0x65104327);
	regal_write(pkt, REAGL_MASK_010, 0x04327651);
	regal_write(pkt, REAGL_MASK_011, 0x04327651);
	regal_write(pkt, REAGL_MASK_012, 0x27651043);
	regal_write(pkt, REAGL_MASK_013, 0x27651043);
	regal_write(pkt, REAGL_MASK_014, 0x51043276);
	regal_write(pkt, REAGL_MASK_015, 0x51043276);
	regal_write(pkt, REAGL_MASK_016, 0x43276510);
	regal_write(pkt, REAGL_MASK_017, 0x43276510);
	regal_write(pkt, REAGL_MASK_018, 0x76510432);
	regal_write(pkt, REAGL_MASK_019, 0x76510432);
	regal_write(pkt, REAGL_MASK_020, 0x10432765);
	regal_write(pkt, REAGL_MASK_021, 0x10432765);
	regal_write(pkt, REAGL_MASK_022, 0x32765104);
	regal_write(pkt, REAGL_MASK_023, 0x32765104);
	regal_write(pkt, REAGL_MASK_024, 0x65104327);
	regal_write(pkt, REAGL_MASK_025, 0x65104327);
	regal_write(pkt, REAGL_MASK_026, 0x04327651);
	regal_write(pkt, REAGL_MASK_027, 0x04327651);
	regal_write(pkt, REAGL_MASK_028, 0x27651043);
	regal_write(pkt, REAGL_MASK_029, 0x27651043);
	regal_write(pkt, REAGL_MASK_030, 0x51043276);
	regal_write(pkt, REAGL_MASK_031, 0x51043276);
	regal_write(pkt, REAGLD_FRAME_CNT, 0x00000000);
}
	...
	int img_width, int img_height)
{
	...
	case REGAL_MODE_REGAL:
		...
		break;
	case REGAL_MODE_REGAL_D:
		regal_write(pkt, REAGL_SFT_UPDATE, 0x1D1D1F33);
		regal_write(pkt, ECLIPSE_SIT_UPDATE, 0x33153000);
		break;
	case REGAL_MODE_NIGHT:
		regal_write(pkt, REAGL_SFT_UPDATE, 0x1D1D1F31);
		regal_write(pkt, ECLIPSE_SIT_UPDATE, 0x33153001);
		break;
	case REGAL_MODE_DRAK:
		regal_write(pkt, REAGL_SFT_UPDATE, 0x1D1D1F31);
		regal_write(pkt, ECLIPSE_SIT_UPDATE, 0x33153004);
		break;
	case REGAL_MODE_DARK_D:
		regal_write(pkt, REAGL_SFT_UPDATE, 0x1D1D1F31);
		regal_write(pkt, ECLIPSE_SIT_UPDATE, 0x33153006);
		break;
	case REGAL_MODE_DARK_DU:
		regal_write(pkt, REAGL_SFT_UPDATE, 0x1D1D1F30);
		regal_write(pkt, ECLIPSE_SIT_UPDATE, 0x33153008);
		break;
	default:
	...
	if (regal_mode == REGAL_MODE_REGAL_D)
		hwtcon_regal_config_regal_d(pkt);
	else
