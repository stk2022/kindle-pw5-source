...
#ifndef _MT8512_THERMAL_H
#define _MT8512_THERMAL_H
 ...
 *****************************************************************************
 */
#define INFRA_THER_RST_SET  (INFRACFG_AO_BASE + 0x120)
#define INFRA_THER_RST_CLR  (INFRACFG_AO_BASE + 0x124)
/*******************************************************************************
