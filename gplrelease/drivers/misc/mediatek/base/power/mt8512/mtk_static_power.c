...
#define SPOWER_COMPATIBLE_NODE "mediatek,mt8512-spower"
...
int interpolate_2d(struct sptbl_t *tab,
...
void interpolate_table(struct sptbl_t *spt,
...
int mt_spower_make_table(struct sptbl_t *spt,
	struct spower_raw_t *spower_raw, int wat, int voltage, int degree)
{
	int i;
	int c1, c2, c = -1;
	struct sptbl_t *tab1, *tab2, *tspt;
	struct sptbl_t tab[MAX_TABLE_SIZE] = {};
...
{
	#define DEVINFO_IDX0 (59)
	#define DEVINFO_MP0_BIT (0)
	int devinfo;
	int mp0;
