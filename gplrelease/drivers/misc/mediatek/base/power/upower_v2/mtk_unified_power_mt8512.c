...
struct upower_tbl_info upower_tbl_list[NR_UPOWER_TBL_LIST][NR_UPOWER_BANK] = {
	...
	/* FY2 */
	[1] = {
	INIT_UPOWER_TBL_INFOS(UPOWER_BANK_L, upower_tbl_l_FY2),
	},
	/* FY3 */
	[2] = {
	INIT_UPOWER_TBL_INFOS(UPOWER_BANK_L, upower_tbl_l_FY3),
	},

};
/* Upower will know how to apply voltage that comes from EEM */
unsigned char upower_recognize_by_svs[NR_UPOWER_BANK] = {
