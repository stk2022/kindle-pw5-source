...
#define CMDQ_HWTCON_PREDUMP_TIMEOUT_MS         (750)
...
#define CMDQ_THR_FREE_CPR_MAX		(100)	/* total 128, only thread 0 & 1 can use cpr */
...
enum CMDQ_SCENARIO_ENUM {
	...
	/* HWTCON trigger loop */
	CMDQ_SCENARIO_HWTCON_LUT_END_LOOP = 6,
	CMDQ_SCENARIO_HWTCON_AUTO_COLLISION_LOOP = 7,
	CMDQ_SCENARIO_PIPELINE = 8,
	CMDQ_SCENARIO_WF_LUT = 9,
