...
#endif
extern struct _MTK_BTIF_INFO_STR_ mtk_btif_info;
...
err_exit2:
	...
	/*free memory of btif_info*/
	if (mtk_btif_info.p_tx_fifo) {
		kfifo_free(mtk_btif_info.p_tx_fifo);
		kfree(mtk_btif_info.p_tx_fifo);
		mtk_btif_info.p_tx_fifo = NULL;
	}
