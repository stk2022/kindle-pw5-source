...
static int mt8512_codec_dac_depop_setup(
	struct snd_soc_component *component)
{
	...
	int rate)
{
	...
	snd_soc_component_update_bits(component, AFE_ADDA_PREDIS_CON0,
		AFE_ADDA_PREDIS_CON0_PREDIS_A2_CH1_MASK,
		AFE_ADDA_PREDIS_CON0_PREDIS_A2_CH1_VAL(0x800));

	snd_soc_component_update_bits(component, AFE_ADDA_PREDIS_CON0,
		AFE_ADDA_PREDIS_CON0_PREDIS_A3_CH1_MASK,
		AFE_ADDA_PREDIS_CON0_PREDIS_A3_CH1_VAL(0x400));

	snd_soc_component_update_bits(component, AFE_ADDA_PREDIS_CON0,
		AFE_ADDA_PREDIS_CON0_PREDIS_CH1_ON_MASK,
		AFE_ADDA_PREDIS_CON0_PREDIS_CH1_ON);

	snd_soc_component_update_bits(component, AFE_ADDA_PREDIS_CON1,
		AFE_ADDA_PREDIS_CON1_PREDIS_A2_CH2_MASK,
		AFE_ADDA_PREDIS_CON1_PREDIS_A2_CH2_VAL(0x800));

	snd_soc_component_update_bits(component, AFE_ADDA_PREDIS_CON1,
		AFE_ADDA_PREDIS_CON1_PREDIS_A3_CH2_MASK,
		AFE_ADDA_PREDIS_CON1_PREDIS_A3_CH2_VAL(0x408));
...
static const struct mt8512_codec_reg_attr mt8512_codec_dump_reg_list[] = {
	...
	DUMP_REG_ENTRY(AMIC_GAIN_CON0),
	DUMP_REG_ENTRY(AMIC_GAIN_CON1),
	DUMP_REG_ENTRY(AMIC_GAIN_CON2),
	DUMP_REG_ENTRY(AMIC_GAIN_CON3),
	DUMP_REG_ENTRY(AMIC_GAIN_CUR),
